...
describe("commonKeyHandler", () => {
  ...
  it("Correct routing based on intervention: CCC", () => {
    ...
    commonKeyHandler(InterventionFormat.CoverCopyCompare, "1", state, dispatch);
  ...
  it("Flawed routing throws error", () => {
    ...
    expect(() => commonKeyHandler("asdf", "1", state, dispatch)).toThrowError(
      Error("No intervention type specified")
    );
  });
});
