...
describe('ButtonLayout', () => {
    const spyButtonSequence = jest.spyOn(InterventionHelpers, 'sharedButtonActionSequence');
    ...
    it('Should render and "click" through', async () => {
        spyButtonSequence.mockImplementation((user: firebase.User | null,
            id: string,
            target: string,
            approach: string,
            ...
            history: any,
            dispatch: any) => true)
        spyButtonHelper.mockImplementation((event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => true);
    ...
    it('Should render and NOT "key" through', async () => {
        spyButtonSequence.mockImplementation((user: firebase.User | null,
            ...
            history: any,
            dispatch: any) => true)
        spyButtonHelper.mockImplementation((event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => false);
