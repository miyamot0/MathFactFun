...
export default function ProgressMonitor() {
    ...
    useEffect(() => {
        if (documents) {
            const overallCalculations = prepareOverallCalculations(
                documents,
                aim
            )
            ...
            setChartOptions({
                mainChart: getPrimaryProgressChartData(
                    overallCalculations,
                    aim
                ),
                itemChart: getSecondaryProgressChartData(
    ...
    return (
        <>
            ...
            >
                ...
                />
                <p>
                    Latency Legend: Circle (&lt;5s), Triange (&lt;10s), Diamond
                    (&lt;15s), otherwise Square
                </p>
                <p>
                    Accuracy Legend: Red (&lt;50%), Orange (&lt;80%), otherwise
                    Green
                </p>
                <p>
                    Size Legend: Max Size (&gt;4 OTRs), otherwise Smaller Size
                </p>
            </div>
            <br></br>
        </>
